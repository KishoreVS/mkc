			...
			switch(dashboardUserInput) {
			 	...
			 	case "1":
			 	 ...
			 	 case "2":
			 		 ...
			 		 int i = serviceObject.SignIn(Integer.parseInt(loggedInAccountId), loggedInAccountPassword);
			 			...
			 			while(!returnToDashboard) {
			 				...
			 				switch(signInInput) {
			 				 	 ...
			 				 	 case "1":
			 				 		 ...
			 				 		 System.out.println(serviceObject.showBalance(Integer.parseInt(loggedInAccountId)));
			 				 		 break;
			 				 	 ...
			 				 	 case "2":
			 				 		 ...
			 				 		 System.out.println(serviceObject.deposit(Integer.parseInt(loggedInAccountId), Integer.parseInt(amount)));
			 				 		 break;
			 				 	 ...
			 				 	 case "3":
			 				 		 ...
			 				 		 System.out.println(serviceObject.withDraw(Integer.parseInt(loggedInAccountId), Integer.parseInt(amount)));
			 				 		 break;
...
//			 				 		 }
			 				 		 ...
			 				 		 System.out.println(serviceObject.fundTransfer(Integer.parseInt(loggedInAccountId), Integer.parseInt(accountId2),Integer.parseInt(amount)));
			 				 		 break;
			 				 		 
			 				 	 case "5":
			 				 		 //print transaction part done here
			 				 		 System.out.println(serviceObject.printTransactions(Integer.parseInt(loggedInAccountId)));
			 				 		 break;
